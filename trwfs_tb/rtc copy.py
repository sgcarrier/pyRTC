...
for i in range(iterations):
    try:
        ...
        print(np.max(np.abs(wfc.currentShape)))
        print(f"it = {i}, RMS={rms_plot[i]:.4f}, RMS_SR={rms_strehl[i]:.4f}, SR={strehls[i]:.4f}")
...
#ax1.plot(rms_plot_norm_2_01g*1000, "r", label="Modulated - 0.1g")
ax1.plot(rms_plot_norm_fixed_03g*1000, "r--",label="Modulated - 0.3g")
#ax1.plot(rms_plot_tr_2_01g*1000, "b",label="TR - 0.1g")
ax1.plot(rms_plot_tr_fixed_03g*1000, "b--", label="TR - 0.3g")
#ax1.plot(rms_plot_ff_10_03g*1000, "g",label="TR-Cube - 0.3g")
ax1.plot(rms_plot_ff_fixed_03g*1000, "g--",label="TR-Cube - 0.3g")
ax1.set_title("WFE RMS (nm)")

#ax2.plot(strehl_norm_2_01g, "r",label="Modulated - 0.1g")
ax2.plot(strehl_norm_fixed_03g, "r--", label="Modulated - 0.3g")
#ax2.plot(strehl_tr_2_01g, "b",label="TR - 0.1g")
ax2.plot(strehl_tr_fixed_03g,"b--", label="TR - 0.3g")
#ax2.plot(strehl_ff_10_03g,"g", label="TR-Cube - 0.3g")
ax2.plot(strehl_ff_fixed_03g, "g--",label="TR-Cube - 0.3g")
ax2.set_title("Strehl")
